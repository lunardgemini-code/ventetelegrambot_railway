...
class DashboardPwaTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_liquid_theme_assets_are_part_of_the_versioned_app_shell(self):
        ...
        self.assertIn("operations.css?v=20260723-mobile-products-v1", self.worker)
        self.assertIn("app.js?v=20260723-mobile-products-v1", self.worker)
        self.assertIn("operations.js?v=20260723-ops-v2", self.worker)
        self.assertIn("ventebot-dashboard-shell-20260723-mobile-products-v1", self.worker)
