...
TRANSLATIONS["en"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>Don't forget the fees.</b> The BEP20 address must receive exactly the amount shown above.",
...
TRANSLATIONS["fr"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>N'oubliez pas les frais.</b> L'adresse BEP20 doit recevoir exactement le montant affiche ci-dessus.",
...
TRANSLATIONS["ar"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>لا تنس الرسوم.</b> يجب أن يستلم عنوان BEP20 المبلغ الموضح أعلاه بالكامل.",
...
TRANSLATIONS["zh"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>请勿忘记手续费。</b>BEP20 地址必须收到上方显示的准确金额。",
...
TRANSLATIONS["vi"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>Đừng quên phí.</b> Địa chỉ BEP20 phải nhận chính xác số tiền hiển thị ở trên.",
...
TRANSLATIONS["ru"].update({
    ...
    "nowpayments_fee_warning": "⚠️ <b>Не забудьте о комиссии.</b> На адрес BEP20 должна поступить точная сумма, указанная выше.",
