...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "delivery_error": "⚠️ Automatic delivery encountered a problem.\nAn admin will contact you shortly.",
    ...
    "fr": {
        ...
        "delivery_error": "⚠️ La livraison automatique a rencontré un problème.\nUn administrateur vous contactera sous peu.",
    ...
    "ar": {
        ...
        "delivery_error": "⚠️ واجه التسليم التلقائي مشكلة.\nسيتواصل معك المسؤول قريباً.",
