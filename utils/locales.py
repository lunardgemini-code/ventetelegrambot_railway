...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "pixel_mode_normal": "🐢 Extract Link (Normal — 5 PTS)",
        "pixel_mode_fast_sub": "⚡ Fast (6 PTS) — mins/hours",
        "pixel_mode_normal_sub": "🐢 Normal (5 PTS) — up to 24h",
        "pixel_prompt_creds": "✨ <b>Pixel Gemini Activation</b>\n⚙️ <b>Selected Mode:</b> <code>{mode}</code>\n\nPlease send Google account credentials in the format:\n\n<code>email|password|32_character_2fa_secret</code>\n\n<i>Example:</i>\n<code>testuser@gmail.com|mypassword123|JBSWY3DPEHPK3PXPJBSWY3DPEHPK3PXP</code>",
        "pixel_invalid_format": "⚠️ <b>Invalid credentials format.</b>\n\nPlease send in exact format:\n<code>email|password|32_character_2fa_secret</code>",
        "pixel_submitting": "⏳ <b>Submitting Pixel Gemini activation...</b>",
        "pixel_submit_success": "✅ <b>Activation Task Submitted Successfully!</b>\n\n⚡ <b>Task ID:</b> <code>#{task_id}</code>\n📧 <b>Account:</b> <code>{email}</code>\n⚙️ <b>Mode:</b> <code>{mode_id}</code>\n📊 <b>Initial Status:</b> <code>pending</code>\n\n<i>Promotion is being activated on Pixel Gemini.</i>",
        "pixel_submit_error": "❌ <b>Pixel activation submission failed:</b>\n\n<code>{error}</code>",
        "pixel_query_btn": "🔍 Check Status (Query)",
        "pixel_new_btn": "✨ New Activation",
        "pixel_status_title": "{emoji} <b>Pixel Gemini Task Status #{display_id}</b>\n\n📊 <b>Status:</b> <code>{status}</code>",
        "pixel_refresh_btn": "🔄 Refresh Status",
        ...
        "product_temporarily_hidden": "⏳ This product has been out of stock for a while and is temporarily hidden. You can return to the catalog to choose another product.",
    ...
    "fr": {
        ...
        "pixel_prompt_creds": "✨ <b>Activation Pixel Gemini</b>\n⚙️ <b>Mode Sélectionné :</b> <code>{mode}</code>\n\nVeuillez envoyer les identifiants du compte Google sous le format :\n\n<code>email|mot_de_passe|secret_2FA_32_caracteres</code>\n\n<i>Exemple :</i>\n<code>testuser@gmail.com|monmotdepasse123|JBSWY3DPEHPK3PXPJBSWY3DPEHPK3PXP</code>",
        "pixel_invalid_format": "⚠️ <b>Format d'identifiants invalide.</b>\n\nVeuillez envoyer sous le format exact :\n<code>email|mot_de_passe|secret_2FA_32_caracteres</code>",
        "pixel_submitting": "⏳ <b>Soumission de l'activation Pixel Gemini en cours...</b>",
        "pixel_submit_success": "✅ <b>Tâche d'Activation Soumise avec Succès !</b>\n\n⚡ <b>ID Tâche :</b> <code>#{task_id}</code>\n📧 <b>Compte :</b> <code>{email}</code>\n⚙️ <b>Mode :</b> <code>{mode_id}</code>\n📊 <b>Statut Initial :</b> <code>pending</code>\n\n<i>La promotion est en cours d'activation sur le bot Pixel Gemini.</i>",
        "pixel_submit_error": "❌ <b>Échec de la soumission de l'activation Pixel :</b>\n\n<code>{error}</code>",
        "pixel_query_btn": "🔍 Vérifier le Statut (Query)",
        "pixel_new_btn": "✨ Nouvelle Activation",
        "pixel_status_title": "{emoji} <b>Statut Tâche Pixel Gemini #{display_id}</b>\n\n📊 <b>Statut :</b> <code>{status}</code>",
        "pixel_refresh_btn": "🔄 Rafraîchir le Statut",
        ...
        "product_temporarily_hidden": "⏳ Ce produit est en rupture depuis un moment et est temporairement masqué. Revenez au catalogue pour choisir un autre produit.",
    ...
    "ar": {
        ...
        "pixel_prompt_creds": "✨ <b>تفعيل بيكسل جيميني</b>\n⚙️ <b>الوضع المحدد:</b> <code>{mode}</code>\n\nيرجى إرسال بيانات حساب جوجل بهذا التنسيق:\n\n<code>البريد|كلمة_المرور|رمز_2FA_32_حرف</code>",
        "pixel_invalid_format": "⚠️ <b>تنسيق البيانات غير صحيح.</b>\n\nيرجى الإرسال بالتنسيق الصحيح:\n<code>البريد|كلمة_المرور|رمز_2FA_32_حرف</code>",
        "pixel_submitting": "⏳ <b>جاري تقديم طلب تفعيل بيكسل جيميني...</b>",
        "pixel_submit_success": "✅ <b>تم تقديم مهمة التفعيل بنجاح!</b>\n\n⚡ <b>معرف المهمة:</b> <code>#{task_id}</code>\n📧 <b>الحساب:</b> <code>{email}</code>\n⚙️ <b>الوضع:</b> <code>{mode_id}</code>",
        "pixel_submit_error": "❌ <b>فشل تقديم طلب تفعيل بيكسل:</b>\n\n<code>{error}</code>",
        "pixel_query_btn": "🔍 التحقق من الحالة",
        "pixel_new_btn": "✨ تفعيل جديد",
        "pixel_status_title": "{emoji} <b>حالة مهمة بيكسل جيميني #{display_id}</b>\n\n📊 <b>الحالة:</b> <code>{status}</code>",
        "pixel_refresh_btn": "🔄 تحديث الحالة",
        ...
        "product_temporarily_hidden": "⏳ هذا المنتج غير متوفر منذ فترة وهو مخفي مؤقتًا. يمكنك العودة إلى الكتالوج واختيار منتج آخر.",
    ...
    "zh": {
        ...
        "pixel_mode_normal": "🐢 提取链接 (Normal — 5 PTS)",
        "pixel_mode_fast_sub": "⚡ 快速 (6 PTS) — 几分钟至数小时",
        "pixel_mode_normal_sub": "🐢 普通 (5 PTS) — 最多24小时",
        "pixel_prompt_creds": "✨ <b>Pixel Gemini 激活</b>\n⚙️ <b>已选模式:</b> <code>{mode}</code>\n\n请按以下格式发送 Google 账号凭据：\n\n<code>邮箱|密码|32位2FA密钥</code>",
        "pixel_invalid_format": "⚠️ <b>凭据格式无效。</b>\n\n请按准确格式发送：\n<code>邮箱|密码|32位2FA密钥</code>",
        "pixel_submitting": "⏳ <b>正在提交 Pixel Gemini 激活任务...</b>",
        "pixel_submit_success": "✅ <b>激活任务提交成功！</b>\n\n⚡ <b>任务 ID:</b> <code>#{task_id}</code>\n📧 <b>账号:</b> <code>{email}</code>\n⚙️ <b>模式:</b> <code>{mode_id}</code>",
        "pixel_submit_error": "❌ <b>Pixel 激活提交失败：</b>\n\n<code>{error}</code>",
        "pixel_query_btn": "🔍 查询状态",
        "pixel_new_btn": "✨ 新建激活",
        "pixel_status_title": "{emoji} <b>Pixel Gemini 任务状态 #{display_id}</b>\n\n📊 <b>状态:</b> <code>{status}</code>",
        "pixel_refresh_btn": "🔄 刷新状态",
        "btn_change_mode": "🔄 更改模式",
        "btn_pixel_activation": "✨ Pixel 激活 (管理员)",
        "pixel_title": "✨ <b>Pixel Gemini 激活工具 (管理员)</b>\n\n请选择用于 Google 账号激活的任务模式：",
        ...
        "product_temporarily_hidden": "⏳ 该产品缺货已有一段时间，现已暂时隐藏。请返回目录选择其他产品。",
...
TRANSLATIONS["vi"] = {
    **TRANSLATIONS["en"],
    ...
    "product_temporarily_hidden": "⏳ Sản phẩm này đã hết hàng một thời gian và đang tạm ẩn. Hãy quay lại danh mục để chọn sản phẩm khác.",
...
TRANSLATIONS["ru"] = {
    **TRANSLATIONS["en"],
    ...
    "product_temporarily_hidden": "⏳ Товара давно нет в наличии, поэтому он временно скрыт. Вернитесь в каталог и выберите другой товар.",
...
_BYBIT_TRANSFER_TRANSLATIONS = {
    "en": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>Payment via Bybit</b>",
        "bybit_uid_lbl": "<b>Bybit UID</b> (tap to copy):",
        "bybit_transfer_step1": "1. Send the exact amount to this UID using an internal Bybit transfer.",
        "bybit_transfer_step2": "2. Find the TxID in your Bybit transfer details, then send it here. Example: <code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "Bybit verification is temporarily unavailable.",
        "bybit_transfer_invalid_id": "This Bybit transaction ID is invalid.",
        "bybit_transfer_not_found": "No incoming Bybit transfer was found with this transaction ID.",
        "bybit_transfer_pending": "This Bybit transfer is still processing. Please try again shortly.",
        "bybit_transfer_wrong_coin": "This transfer was not received in USDT.",
        "bybit_transfer_underpaid": "Underpayment: received {received} USDT, expected at least {expected} USDT.",
        "bybit_transfer_too_old": "This Bybit transfer is too old to pay this order.",
        "bybit_transfer_invalid_time": "The Bybit transfer timestamp is invalid. Please contact support.",
    },
    "fr": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>Paiement avec Bybit</b>",
        "bybit_uid_lbl": "<b>UID Bybit</b> (appuyez pour copier) :",
        "bybit_transfer_step1": "1. Envoyez le montant exact à cet UID avec un transfert interne Bybit.",
        "bybit_transfer_step2": "2. Cherchez le TxID dans les détails du transfert Bybit, puis envoyez-le ici. Exemple : <code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "La vérification Bybit est temporairement indisponible.",
        "bybit_transfer_invalid_id": "Cet identifiant de transaction Bybit est invalide.",
        "bybit_transfer_not_found": "Aucun transfert Bybit entrant ne correspond à cet identifiant.",
        "bybit_transfer_pending": "Ce transfert Bybit est encore en traitement. Réessayez dans quelques instants.",
        "bybit_transfer_wrong_coin": "Ce transfert n'a pas été reçu en USDT.",
        "bybit_transfer_underpaid": "Sous-paiement : {received} USDT reçus, au moins {expected} USDT attendus.",
        "bybit_transfer_too_old": "Ce transfert Bybit est trop ancien pour payer cette commande.",
        "bybit_transfer_invalid_time": "La date du transfert Bybit est invalide. Contactez le support.",
    },
    "ar": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>الدفع عبر Bybit</b>",
        "bybit_uid_lbl": "<b>معرف Bybit UID</b> (اضغط للنسخ):",
        "bybit_transfer_step1": "1. أرسل المبلغ الدقيق إلى هذا المعرف عبر تحويل Bybit داخلي.",
        "bybit_transfer_step2": "2. ابحث عن TxID في تفاصيل تحويل Bybit ثم أرسله هنا. مثال: <code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "التحقق من Bybit غير متاح مؤقتا.",
        "bybit_transfer_invalid_id": "معرف معاملة Bybit غير صالح.",
        "bybit_transfer_not_found": "لم يتم العثور على تحويل Bybit وارد بهذا المعرف.",
        "bybit_transfer_pending": "تحويل Bybit لا يزال قيد المعالجة. حاول بعد قليل.",
        "bybit_transfer_wrong_coin": "لم يتم استلام هذا التحويل بعملة USDT.",
        "bybit_transfer_underpaid": "دفع ناقص: تم استلام {received} USDT والمطلوب {expected} USDT على الأقل.",
        "bybit_transfer_too_old": "تحويل Bybit هذا قديم جدا لاستخدامه لهذه الطلبية.",
        "bybit_transfer_invalid_time": "وقت تحويل Bybit غير صالح. اتصل بالدعم.",
    },
    "zh": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>使用 Bybit 付款</b>",
        "bybit_uid_lbl": "<b>Bybit UID</b>（点击复制）：",
        "bybit_transfer_step1": "1. 通过 Bybit 内部转账向此 UID 发送准确金额。",
        "bybit_transfer_step2": "2. 在 Bybit 转账详情中找到 TxID，然后发送到这里。例如：<code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "Bybit 验证暂时不可用。",
        "bybit_transfer_invalid_id": "此 Bybit 交易 ID 无效。",
        "bybit_transfer_not_found": "未找到与此交易 ID 匹配的 Bybit 入账。",
        "bybit_transfer_pending": "此 Bybit 转账仍在处理中，请稍后重试。",
        "bybit_transfer_wrong_coin": "此转账不是以 USDT 收取的。",
        "bybit_transfer_underpaid": "付款不足：已收到 {received} USDT，至少需要 {expected} USDT。",
        "bybit_transfer_too_old": "此 Bybit 转账时间过早，不能支付该订单。",
        "bybit_transfer_invalid_time": "Bybit 转账时间无效，请联系客服。",
    },
    "vi": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>Thanh toán qua Bybit</b>",
        "bybit_uid_lbl": "<b>Bybit UID</b> (nhấn để sao chép):",
        "bybit_transfer_step1": "1. Gửi đúng số tiền đến UID này bằng chuyển khoản nội bộ Bybit.",
        "bybit_transfer_step2": "2. Tìm TxID trong chi tiết chuyển khoản Bybit rồi gửi tại đây. Ví dụ: <code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "Xác minh Bybit tạm thời không khả dụng.",
        "bybit_transfer_invalid_id": "Mã giao dịch Bybit không hợp lệ.",
        "bybit_transfer_not_found": "Không tìm thấy khoản chuyển Bybit đến với mã giao dịch này.",
        "bybit_transfer_pending": "Khoản chuyển Bybit vẫn đang xử lý. Vui lòng thử lại sau.",
        "bybit_transfer_wrong_coin": "Khoản chuyển này không được nhận bằng USDT.",
        "bybit_transfer_underpaid": "Thanh toán thiếu: đã nhận {received} USDT, cần ít nhất {expected} USDT.",
        "bybit_transfer_too_old": "Khoản chuyển Bybit này quá cũ để thanh toán đơn hàng.",
        "bybit_transfer_invalid_time": "Thời gian chuyển Bybit không hợp lệ. Vui lòng liên hệ hỗ trợ.",
    },
    "ru": {
        "btn_pay_bybit": "Bybit",
        "bybit_transfer_title": "<b>Оплата через Bybit</b>",
        "bybit_uid_lbl": "<b>Bybit UID</b> (нажмите, чтобы скопировать):",
        "bybit_transfer_step1": "1. Отправьте точную сумму на этот UID внутренним переводом Bybit.",
        "bybit_transfer_step2": "2. Найдите TxID в деталях перевода Bybit и отправьте его сюда. Пример: <code>01d90...7c589</code>",
        "bybit_transfer_unavailable": "Проверка Bybit временно недоступна.",
        "bybit_transfer_invalid_id": "Неверный ID транзакции Bybit.",
        "bybit_transfer_not_found": "Входящий перевод Bybit с таким ID не найден.",
        "bybit_transfer_pending": "Перевод Bybit еще обрабатывается. Повторите попытку позже.",
        "bybit_transfer_wrong_coin": "Этот перевод получен не в USDT.",
        "bybit_transfer_underpaid": "Недоплата: получено {received} USDT, требуется не менее {expected} USDT.",
        "bybit_transfer_too_old": "Этот перевод Bybit слишком старый для оплаты заказа.",
        "bybit_transfer_invalid_time": "Время перевода Bybit некорректно. Обратитесь в поддержку.",
    },
}
for _bybit_lang, _bybit_strings in _BYBIT_TRANSFER_TRANSLATIONS.items():
...
_CASHBACK_TRANSLATIONS = {
    "en": {
        ...
        "cashback_minimum_required": "You need <b>{minimum} points</b> to claim. You currently have <b>{points} points</b>.",
    ...
    "fr": {
        ...
        "cashback_minimum_required": "Vous avez besoin de <b>{minimum} points</b> pour réclamer. Vous avez actuellement <b>{points} points</b>.",
    ...
    "ar": {
        ...
        "cashback_minimum_required": "تحتاج إلى <b>{minimum} نقطة</b> للتحويل. لديك حاليًا <b>{points} نقطة</b>.",
    ...
    "zh": {
        ...
        "cashback_minimum_required": "您需要 <b>{minimum} 积分</b>才能兑换。您目前有 <b>{points} 积分</b>。",
    ...
    "vi": {
        ...
        "cashback_minimum_required": "Bạn cần <b>{minimum} điểm</b> để nhận tiền. Hiện bạn có <b>{points} điểm</b>.",
    ...
    "ru": {
        ...
        "cashback_minimum_required": "Для вывода требуется <b>{minimum} баллов</b>. Сейчас у вас <b>{points} баллов</b>.",
