...
_BYBIT_TRANSFER_TRANSLATIONS = {
    "en": {
        ...
        "bybit_transfer_step2": "2. Then send the Bybit transaction ID here.",
    ...
    "fr": {
        ...
        "bybit_transfer_step2": "2. Envoyez ensuite ici l'identifiant de transaction Bybit.",
    ...
    "ar": {
        ...
        "bybit_transfer_step2": "2. ثم أرسل معرف معاملة Bybit هنا.",
    ...
    "zh": {
        ...
        "bybit_transfer_step2": "2. 然后在此发送 Bybit 交易 ID。",
    ...
    "vi": {
        ...
        "bybit_transfer_step2": "2. Sau đó gửi mã giao dịch Bybit tại đây.",
    ...
    "ru": {
        ...
        "bybit_transfer_step2": "2. Затем отправьте сюда ID транзакции Bybit.",
