...
TRANSLATIONS["en"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "Open Bybit Pay",
    "btn_check_bybitpay": "Check payment",
    "bybitpay_title": "<b>Bybit Pay</b>",
    "bybitpay_amount": "<b>Amount:</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>Payment:</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "Open Bybit Pay, complete the payment, then return here. Confirmation is automatic.",
    "bybitpay_waiting": "Waiting for your payment...",
    "bybitpay_checking_short": "Checking payment...",
    "bybitpay_checking": "Checking your Bybit Pay payment...",
    "bybitpay_expired": "This Bybit Pay payment has expired. Create a new payment from the payment methods.",
    "bybitpay_unavailable": "Bybit Pay is temporarily unavailable. Please try again shortly.",
    "bybitpay_creation_unknown": "The payment may have been created without a response. Do not retry repeatedly; contact support with reference {reference}.",
    "bybitpay_paid_pending": "Payment confirmed. Order #{order_id} is being processed.",
    "bybitpay_review": "Payment received but held for a security review. An administrator has been notified.",
...
TRANSLATIONS["fr"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "Ouvrir Bybit Pay",
    "btn_check_bybitpay": "Verifier le paiement",
    "bybitpay_title": "<b>Paiement Bybit Pay</b>",
    "bybitpay_amount": "<b>Montant :</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>Paiement :</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "Ouvrez Bybit Pay, terminez le paiement, puis revenez ici. La confirmation est automatique.",
    "bybitpay_waiting": "En attente de votre paiement...",
    "bybitpay_checking_short": "Verification du paiement...",
    "bybitpay_checking": "Verification de votre paiement Bybit Pay...",
    "bybitpay_expired": "Ce paiement Bybit Pay a expire. Creez un nouveau paiement depuis les methodes de paiement.",
    "bybitpay_unavailable": "Bybit Pay est temporairement indisponible. Reessayez dans quelques instants.",
    "bybitpay_creation_unknown": "Le paiement a peut-etre ete cree sans reponse. Ne recommencez pas plusieurs fois et contactez le support avec la reference {reference}.",
    "bybitpay_paid_pending": "Paiement confirme. La commande #{order_id} est en cours de traitement.",
    "bybitpay_review": "Paiement recu mais place en verification de securite. Un administrateur a ete averti.",
    "btn_pay_nowpayments": "BEP20",
...
TRANSLATIONS["ar"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "فتح Bybit Pay",
    "btn_check_bybitpay": "التحقق من الدفع",
    "bybitpay_title": "<b>الدفع عبر Bybit Pay</b>",
    "bybitpay_amount": "<b>المبلغ:</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>الدفع:</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "افتح Bybit Pay وأكمل الدفع ثم عد إلى هنا. يتم التأكيد تلقائيا.",
    "bybitpay_waiting": "بانتظار دفعتك...",
    "bybitpay_checking_short": "جار التحقق من الدفع...",
    "bybitpay_checking": "جار التحقق من دفعة Bybit Pay...",
    "bybitpay_expired": "انتهت صلاحية دفعة Bybit Pay. أنشئ دفعة جديدة من طرق الدفع.",
    "bybitpay_unavailable": "Bybit Pay غير متاح مؤقتا. حاول بعد قليل.",
    "bybitpay_creation_unknown": "ربما تم إنشاء الدفعة من دون رد. لا تكرر المحاولة واتصل بالدعم مع المرجع {reference}.",
    "bybitpay_paid_pending": "تم تأكيد الدفع. الطلب #{order_id} قيد المعالجة.",
    "bybitpay_review": "تم استلام الدفع ووضعه قيد المراجعة الأمنية. تم إشعار المسؤول.",
    "btn_pay_nowpayments": "BEP20",
...
TRANSLATIONS["zh"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "打开 Bybit Pay",
    "btn_check_bybitpay": "检查付款",
    "bybitpay_title": "<b>Bybit Pay 付款</b>",
    "bybitpay_amount": "<b>金额：</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>付款：</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "打开 Bybit Pay 并完成付款，然后返回此处。系统会自动确认。",
    "bybitpay_waiting": "正在等待付款...",
    "bybitpay_checking_short": "正在检查付款...",
    "bybitpay_checking": "正在检查 Bybit Pay 付款...",
    "bybitpay_expired": "此 Bybit Pay 付款已过期。请从付款方式中创建新付款。",
    "bybitpay_unavailable": "Bybit Pay 暂时不可用，请稍后重试。",
    "bybitpay_creation_unknown": "付款可能已创建但未返回响应。请勿重复尝试，并将参考号 {reference} 提交给客服。",
    "bybitpay_paid_pending": "付款已确认。订单 #{order_id} 正在处理中。",
    "bybitpay_review": "付款已收到，但正在进行安全审核。管理员已收到通知。",
    "btn_pay_nowpayments": "BEP20",
...
TRANSLATIONS["vi"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "Mo Bybit Pay",
    "btn_check_bybitpay": "Kiem tra thanh toan",
    "bybitpay_title": "<b>Thanh toan Bybit Pay</b>",
    "bybitpay_amount": "<b>So tien:</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>Thanh toan:</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "Mo Bybit Pay, hoan tat thanh toan, sau do quay lai day. He thong tu dong xac nhan.",
    "bybitpay_waiting": "Dang cho thanh toan...",
    "bybitpay_checking_short": "Dang kiem tra thanh toan...",
    "bybitpay_checking": "Dang kiem tra thanh toan Bybit Pay...",
    "bybitpay_expired": "Thanh toan Bybit Pay da het han. Tao thanh toan moi tu danh sach phuong thuc.",
    "bybitpay_unavailable": "Bybit Pay tam thoi khong kha dung. Vui long thu lai sau.",
    "bybitpay_creation_unknown": "Thanh toan co the da duoc tao nhung khong co phan hoi. Khong thu lai nhieu lan; lien he ho tro voi ma {reference}.",
    "bybitpay_paid_pending": "Thanh toan da xac nhan. Don hang #{order_id} dang duoc xu ly.",
    "bybitpay_review": "Da nhan thanh toan nhung dang duoc kiem tra bao mat. Quan tri vien da duoc thong bao.",
    "btn_pay_nowpayments": "BEP20",
...
TRANSLATIONS["ru"].update({
    "btn_pay_bybitpay": "Bybit Pay",
    "btn_open_bybitpay": "Открыть Bybit Pay",
    "btn_check_bybitpay": "Проверить платеж",
    "bybitpay_title": "<b>Оплата через Bybit Pay</b>",
    "bybitpay_amount": "<b>Сумма:</b> <code>${amount}</code>",
    "bybitpay_reference": "<b>Платеж:</b> <code>{invoice_id}</code>",
    "bybitpay_instructions": "Откройте Bybit Pay, завершите оплату и вернитесь сюда. Подтверждение выполняется автоматически.",
    "bybitpay_waiting": "Ожидаем оплату...",
    "bybitpay_checking_short": "Проверяем платеж...",
    "bybitpay_checking": "Проверяем платеж Bybit Pay...",
    "bybitpay_expired": "Срок платежа Bybit Pay истек. Создайте новый платеж в списке способов оплаты.",
    "bybitpay_unavailable": "Bybit Pay временно недоступен. Повторите попытку позже.",
    "bybitpay_creation_unknown": "Платеж мог быть создан без ответа. Не повторяйте попытку много раз; обратитесь в поддержку с номером {reference}.",
    "bybitpay_paid_pending": "Платеж подтвержден. Заказ #{order_id} обрабатывается.",
    "bybitpay_review": "Платеж получен и отправлен на проверку безопасности. Администратор уведомлен.",
    "btn_pay_nowpayments": "BEP20",
