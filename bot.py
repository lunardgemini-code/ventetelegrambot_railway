...
def main() -> None:
    ...
    app.add_handler(CallbackQueryHandler(pixel_topup_select_pack, pattern=r"^pixel_topup_buy:"))
    app.add_handler(CallbackQueryHandler(pixel_topup_execute_wallet, pattern=r"^pixel_topup_exec:"))
